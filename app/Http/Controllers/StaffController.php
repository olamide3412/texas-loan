...
class StaffController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $rules = [
            ...
            'gender' => ['required'],
            'phone_number' => ['required', 'min:11', 'unique:staff'],
    ...
    public function update(Request $request, Staff $staff)
    {
       $request->merge([
        ...
        $rules = [
            ...
            'gender' => ['required'],
            'phone_number' => ['required', 'min:11', Rule::unique('staff')->ignore($staff->id)],
            'email' => ['required', 'email', Rule::unique('staff')->ignore($staff->id), Rule::unique('users')->ignore($staff->user_id)],
            'date_of_birth' => ['nullable', 'date'],
            'residential_address' => ['nullable', 'string'],
            'local_government' => ['nullable', 'string'],
            'state' => ['nullable', 'string'],
